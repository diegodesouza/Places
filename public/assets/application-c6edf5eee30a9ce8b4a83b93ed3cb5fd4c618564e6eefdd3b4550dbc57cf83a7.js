...
(function() {
  $('.datepicker-from').datepicker({
    ...
    onClose: function(selectedDate) {
      ...
      return $('.datepicker-to').datepicker('option', 'minDate', nextDay);
    }
  });
  ...
  $('.datepicker-to').datepicker({
    dateFormat: 'yy-mm-dd',
    onClose: function(selectedDate) {
      return $('.datepicker-from').datepicker('option', 'maxDate', selectedDate);
    }
  });

}).call(this);
(function() {
  $(".notifier__close").click(function() {
    return $(".notifier").remove();
  });
